...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1. Canada horse population of every provinces during 1940-1972.", out.width = "100%"}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
max_horses
kable(max_horses,caption = "Table 1. The Mmximum and minimum horses amount between 1940 - 1972 for each province.")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Figure 2. Number of horses in Alberta", out.width="50%"}
